...
## Environments
- Preview: https://main--setup6--lovelymandal16.hlx.page/
- Live: https://main--setup6--lovelymandal16.hlx.live/
...
1. Open the `setup6` directory in your favorite IDE and start coding :)
